...
class AerialRobotWithObstaclesCfg(BaseConfig):
    ...
    class object_asset_params(asset_state_params):
        num_assets = 17  # Increased to 10 assets
        ...
        specified_positions = [
            ...
            #[-6.0, -3.0, 0.6], # Asset 8
            #[7.0, -5.0, 0.4],  # Asset 9
            #[-3.5, 5.5, 0.3],  # Asset 10
            #[4.0, -2.0, 0.7],  # Asset 11
            #[-5.0, -4.0, 0.2], # Asset 12
        ]

        # Explicitly specified orientations (Euler angles) for each asset
        specified_euler_angles = [
            [0.0, 0.0, 0.0],  # Orientation for Asset 1
            [0.0, 0.0, 0.0],  # Orientation for Asset 2
            [0.0, 0.0, 0.0],  # Orientation for Asset 3
            [0.0, 0.0, 0.0],  # Orientation for Asset 4
            [0.0, 0.0, 0.0],  # Orientation for Asset 5
            [0.0, 0.0, 0.0],  # Orientation for Asset 6
            [0.0, 0.0, 0.0],  # Orientation for Asset 7
            [0.0, 0.0, 0.0],  # Orientation for Asset 8
            [0.0, 0.0, 0.0],  # Orientation for Asset 9
            [0.0, 0.0, 0.0],  # Orientation for Asset 10
            [10.0, 0.0, 0.0],  # Orientation for Asset 1 - rotated 10 degrees around the X axis
            [0.0, 15.0, 0.0],  # Orientation for Asset 2 - rotated 15 degrees around the Y axis
            [0.0, 0.0, 30.0],  # Orientation for Asset 3 - rotated 30 degrees around the Z axis
            [5.0, 10.0, 0.0],  # Orientation for Asset 4 - rotated 5 degrees around X and 10 degrees around Y
            [0.0, 0.0, 45.0],  # Orientation for Asset 5 - rotated 45 degrees around the Z axis
            [20.0, 0.0, 0.0],  # Orientation for Asset 6 - rotated 20 degrees around the X axis
            [0.0, 25.0, 0.0],  # Orientation for Asset 7 - rotated 25 degrees around the Y axis
            #[10.0, 0.0, 10.0], # Orientation for Asset 8 - rotated 10 degrees around X and 10 degrees around Z
            #[0.0, 0.0, 60.0],  # Orientation for Asset 9 - rotated 60 degrees around the Z axis
            #[15.0, 5.0, 5.0],  # Orientation for Asset 10 - rotated 15 degrees around X, 5 degrees around Y and Z
            #[0.0, 0.0, 0.0],  # Orientation for Asset 11
            #[0.0, 0.0, 0.0],  # Orientation for Asset 12
        ]
