...
def obstacle_avoidance(env):
    pid_controller_altitude = PIDController(kp=0.3, ki=0.0, kd=0.1, target=0.5)
    pid_controller_pitch = PIDController(kp=0.1, ki=0.0, kd=0.1, target=0.3)
