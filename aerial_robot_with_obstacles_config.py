...
class AerialRobotWithObstaclesCfg(BaseConfig):
    ...
    class object_asset_params(asset_state_params):
        num_assets = 32  # Increased to 10 assets
        ...
        specified_positions = [
            ...
            #     # New obstacles around the origin, but not too close
            # [3.5, 2.5, 1.1],     # Near origin, right side
            # [-3.5, -2.5, 1.0],   # Near origin, left side
            # [4.0, -3.0, 1.2],    # Below and right
            # [-4.0, 3.0, 0.9],    # Above and left
            # [6.0, -1.5, 1.0],    # Slightly below x-axis
            # [-6.0, 1.5, 1.2],    # Slightly above x-axis
            # [2.5, 5.5, 1.3],     # Slightly above y-axis
            # [-2.5, -5.5, 1.1],   # Slightly below y-axis
            # [5.5, -5.5, 1.2],    # Bottom right
            # [-5.5, 5.5, 1.0],    # Top left
